    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          everySettingsItem(
              mainText: 'ChatApp Direct Calling Setting',
              icon: Icons.call,
    ...
    return OpenContainer(
      ...
      closedBuilder: (_, __) {
        return Container(
          ...
          //container icindeki widgetilari veya column widget'in alani ayarlamak icin height ozelligi kullandik
          height: 70.0,
