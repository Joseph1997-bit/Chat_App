...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget firstPortion(BuildContext context) {
    return SizedBox(
      height: 130,
      //profil fotografi ve kullanici adi yan yana koymak icin Row widgeti kullandim
      child: Row(
        ...
        children: [
          ...
          Align(
            //profil fotografi yerini ayarlamak icin Align widgeti kullandim
            alignment: Alignment.centerLeft,
            //stack widgeti kullandim cunku profil fotograf uzerinde kucuk bi arti iconu koyacm
            child: Stack(
              children: [
                OpenContainer(
                  ...
                  closedBuilder: (context, closeWidget) {
                    return CircleAvatar(
                      //ExactAssetImage demeki gosterilen fotograf ayni orjinal boyut ile gosterileck
...
//kullanici hakinda bazi bilgileri gostermek icin ptherInformation fonksyonu olusturdum
  ...
  Widget _deleteButton(BuildContext context) {
    return Center(
      child: TextButton(
        style: TextButton.styleFrom(//button'in boyutun ve sekli ayarlamak icin styleForm widgti kullandim
          padding: EdgeInsets.symmetric(horizontal: 20.0, vertical: 10.0),
          shape: RoundedRectangleBorder(//buttonin etraflari yuvarlak yapmak icin
  ...
  Future<void> _deleteConformation() async {
    //delete butona bastiktan sonra ekran uyari/Alert cikack cunku onemli bi islem
    showDialog(
        context: context,
        builder: (_) => AlertDialog(
          backgroundColor: const Color.fromRGBO(34, 48, 60, 0.6),
          ...
          //Alert widget'in boyutu ayarlamak icin content ozelligi ve Container widgeti kullandim
          content: Container(
            height: 200.0,
            child: Column(
              ...
              children: [
                ...
                //Cancel ve Sure butonlari olusturmak icin ve yan yana ayarlamak icin Row widgeti kullandim
                Row(
